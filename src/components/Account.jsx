   ...
   <section>
    ...
    >
        <div className=" mx-auto max-w-2xl sm:text-center">
            <Title  title="Now is the time to open your Account."
            className="text-2xl" />
        ...
        <ul   role="list"
          className="mx-auto mt-16 grid max-w-2xl
           grid-cols-1 gap-6 text-sm sm:mt-20 sm:grid-cols-2 
           md:gap-y-10 lg:max-w-none lg:grid-cols-3">
